    ...
    return (
        <Page>
            ...
            <div className={teamcss.teamRow}>
                {teams.data.map(
                    ({ id, login, html_url, avatar_url, type, site_admin }) => (
                        <Team
                            key={id}
                            name={login}
                            url={html_url}
            ...
            <div className={css.aboutSection1Holder}>
                ...
                <div className={css.aboutSection1Right}>
                    <img className={css.halfSectionImage} src="/social.jpg" />
                </div>
            </div>
        </Page>
    );
